...
import DropdownForMobile from "./DropdownForMobile";
  ...
  return (
    <div>
      <div className="drawer">
        ...
        <div className="drawer-content flex items-center my-4 mx-4">
          {/* Page content here */}
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-72 min-h-full bg-base-200 text-base-content">
            ...
            <li className="text-lg py-1 px-2 rounded-lg hover:bg-[#1D91CC] hover:text-white duration-300">
              Flight
            </li>
            <li className="text-lg py-1 px-2 rounded-lg hover:bg-[#1D91CC] hover:text-white duration-300">
              Hotel
            ...
            <li>
              <DropdownForMobile menu={visaMenu}>Visa</DropdownForMobile>
            </li>
            <li className="text-lg py-1 px-2 rounded-lg hover:bg-[#1D91CC] hover:text-white duration-300">
              Medical
            </li>
            ...
            <li>
              <DropdownForMobile menu={otherMenu}>Others</DropdownForMobile>
            </li>
